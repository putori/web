...
export default function BuyerNavbar({
    ...
    const navLinks = [
        { key: "products", label: "Sản phẩm", href: "/products", icon: ShoppingBag },
        { key: "topup", label: "Nạp tiền", href: "/topup", icon: Wallet },
        { key: "history", label: "Lịch sử mua hàng", href: "/history", icon: Clock },
    ] as const;
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-4 ml-auto">
                ...
                {menuOpen && (
                    <div
                        className="absolute top-16 right-8 rounded-xl shadow-2xl py-2 z-50 min-w-[200px]"
                        style={{ backgroundColor: "#141720", border: "1px solid #1e2236" }}
                    >
                        {[
                            { label: "Hồ sơ của tôi", href: "/profile" },
                            { label: "Đơn mua của tôi", href: "/orders" },
                            { label: "Ví TechBid", href: "/wallet" },
